...
export const Icons = {
    logo2: ({ className }: { className?: string }) => (
        <svg
            width="42"
            height="24"
            viewBox="0 0 42 24"
