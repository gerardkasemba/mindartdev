import { HeroVideoSection } from "@/components/modules/hero-video-section";
        ...
        <section id="hero" className="w-full relative">
            <div className="relative flex flex-col items-center w-full px-6">
                ...
                <div className="relative z-10 pt-32 max-w-3xl mx-auto h-full w-full flex flex-col gap-10 items-center justify-center">
                    <p className="border border-border bg-gradient-to-r from-secondary/30 via-background to-secondary/30 rounded-full text-sm h-8 px-3 flex items-center gap-2">
                        {hero.badgeIcon}
                        {hero.badge}
                    </p>
