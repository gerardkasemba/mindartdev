...
export function ReasoningBasic() {
    const reasoningText = `That’s a good starting point, but based on your goals, we recommend extending it with ERC721URIStorage to support metadata management. We can also implement royalty logic if you plan to support creator fees. Would you like us to walk you through a tailored structure?`;
        ...
        >
            ...
            >
                <div className="flex items-end justify-end gap-3">
                    ...
                    >
                        <p className="text-sm">
                            We're thinking of using a basic ERC721 contract for
                            our NFT marketplace. Is that enough?
                        </p>
                    </motion.div>
